...
<div class="navbar-wrapper">
    <nav class="navbar navbar-default navbar-fixed-top navbar-expand-md" role="navigation">
        <div class="container">
            <a class="navbar-brand" href="index.html"><img src="assets/img/innoland.png" style="width: 25px; height: 25px"> IGC Intranet</a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbar">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a class="nav-link page-scroll" href="#features">Forms</a></li>
                    <li><a class="nav-link page-scroll" href="#team">Policies & Memo</a></li>
                    <li><a class="nav-link page-scroll" href="#testimonials">Process Flow/Map</a></li>
                    <li><a class="nav-link page-scroll" href="#pricing">Announcement</a></li>
                </ul>
            </div>
        </div>
    </nav>
...
<!-- IT Ticketing Request Creation -->
<section id="features" class="container services">
    <h1>Create IT Ticket Request</h1>
    <div class="row">
        <div class="col-sm-4">
        ...
        <div class="col-sm-4">
            <div class="form-group  row">
                <label class="col-sm-2 col-form-label">SubCat</label>
                <div class="col-sm-10"><input type="text" class="form-control"></div><br><br><br>
                <label class="col-sm-2 col-form-label">Urgency</label>
                <div class="col-sm-10">
                    <select class="form-control m-b" name="account">
                        <option disabled selected>Please Select Urgency</option>
                        <option>Low Urgency</option>
                        <option>Med Urgency</option>
        ...
        <div class="col-sm-4">
            ...
            <button type="button" class="btn btn-primary pull-right">Create Request</button>
        </div>
    </div>
</section>
<!-- Local Numbers -->
